...
function Profile() {
  ...
  //v161124text   Funktion um alle Benutzer von der API abzurufen
  //v161124  async function fetchUsers() {
  //v161124    try {
  //v161124      const res = await fetch("/api/users");
  //v161124      const usersArr = await res.json();
  //v161124      setUsers(usersArr);
  //v161124    } catch (error) {
  //v161124      console.error("Fehler beim Laden der Benutzerdaten:", error);
  //v161124    }
  //v161124  }

  //v161124text   Funktion, um spezifische Profildaten des angemeldeten Nutzers abzurufen
  ...
  //v161124text   useEffect, um die Daten beim Laden der Komponente zu holen
  useEffect(() => {
    fetchUserProfile(); //v161124text   Lädt die Profildaten des Nutzers
   //v161124 fetchUsers(); //v161124text   Lädt alle Benutzer für die Liste
  }, []);
